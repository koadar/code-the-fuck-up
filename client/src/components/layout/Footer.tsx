        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="text-gray-400 font-code space-y-2">
              <li><Link href="/rants" className="hover:text-white">Hot Rants</Link></li>
              <li><Link href="/tech-lies" className="hover:text-white">Tech Lies We Swallowed</Link></li>
              <li><Link href="/submit-cringe" className="hover:text-white">Cringe Gallery</Link></li>
              <li><Link href="/submit-story" className="hover:text-white">Real Devs, Real Shit</Link></li>
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="text-gray-400 font-code space-y-2">
              <li><Link href="/submit-story" className="hover:text-white">Rage Comment Mode</Link></li>
              <li><Link href="/submit-story" className="hover:text-white">Real Resume Builder</Link></li>
              <li><Link href="/tech-lies" className="hover:text-white">LinkedIn Filter</Link></li>
              <li><button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="hover:text-white">Deploy or Die Button</button></li>
              <li><Link href="/rants" className="hover:text-white">Daily Fuck-Up Generator</Link></li>
